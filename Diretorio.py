...
## O comando abaixo mostra tela para selecionar o diretorio
            directory = tkFileDialog.askdirectory(initialdir = 'C:{}'.format(os.sep), title = 'Selecione o diretorio desejado' \
                                                                                              if not txtDisplay                \
                                                                                              else   txtDisplay)
            return directory
        else:
...
## O comando abaixo mostra tela para selecionar o arquivo nos formatos "myFormats" acima
            arquivo = tkFileDialog.askopenfilename(filetypes = myFormats, title = 'Selecione o arquivo desejado' \
                                                                                  if not txtDisplay              \
                                                                                  else   txtDisplay)
            return arquivo
